...
public class SQLHelper {
    ...
    public static ru.netology.bank.data.DataHelper.VerificationCode getVerificationCode() throws SQLException {
        var codeSQL = "SELECT code FROM auth_codes ORDER BY created DESC LIMIT 1";
        try (var conn = getConn()) {
            var code = runner.query(conn, codeSQL, new ScalarHandler<String>());
            return new ru.netology.bank.data.DataHelper.VerificationCode(code);
    ...
    public static void fillDatabase() {
        var connection = getConn();
        runner.execute(connection, "INSERT INTO app.users (id,login,password,status) VALUES\n" +
        ...
        runner.execute(connection, "INSERT INTO app.cards (id,user_id,`number`,balance_in_kopecks) VALUES\n" +
